                ...
                <tbody>
                	<tr>
                    	<td>
                            ...
                            <div style="margin-left:200px;"><i><?php _e("This feature must be set at YES in the FREE version for Compare Products to work. You can manually deactivate the Compare Button and features from any individual products page edit screen. If you'd prefer to be just able to just activate the Plugin and then add the Compare Products Button and Features to individual Products rather than ALL Products (and then have to deactivate on individual product pages) you can do that by upgrading to the PRO version. IMORTANT! If your theme does not auto show the Campare button on each product page you will need to activate the next option and take the necessary steps.", 'wpec_cp'); ?></i></div>
                            <div style="clear:both; height:20px;"></div>
                            ...
                            <div style="margin-left:200px;"><i><?php _e('You can use this function', 'wpec_cp'); ?> <code>&lt;?php if(function_exists('wpec_show_compare_fields')) echo wpec_show_compare_fields(); ?&gt;</code> <?php _e('to put into your theme code where you want to show Compare Featured fields', 'wpec_cp'); ?></i></div>
                            <div style="clear:both; height:20px;"></div>
                    	</td>
                    </tr>
                    <tr>
