...
class WPEC_Compare_Functions{
	...
	function get_compare_list_html_widget(){
		...
		if(is_array($compare_list) && count($compare_list)>0){
			...
			$html .= '</ul>';
			$html .= '<div class="compare_widget_action"><a class="compare_clear_all" style="cursor:pointer; float:left">Clear All</a> <input style="float:right;" type="button" name="compare_button_go" class="compare_button_go" value="Compare" /><div style="clear:both"></div></div>';
		}else{
