...
class WPEC_Compare_Widget extends WP_Widget
{
	...
	function widget($args, $instance) {
		...
		echo '<div class="wpec_compare_widget_container"></div><div class="wpec_compare_widget_loader" style="display:none; text-align:center"><img src="'.ECCP_IMAGES_URL.'/ajax-loader.gif" border=0 /></div>';
