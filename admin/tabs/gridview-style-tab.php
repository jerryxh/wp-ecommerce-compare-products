...
<?php
/*-----------------------------------------------------------------------------------
WPEC Compare GridView Style Tab
...
class WPEC_Compare_GridView_Style_Tab extends WPEC_Compare_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'product-cards',
			'label'				=> __( 'Product Cards', 'wpec_cp' ),
			'callback_function'	=> 'wpec_compare_gridview_style_tab_manager',
		);
...
global $wpec_compare_gridview_style_tab;
$wpec_compare_gridview_style_tab = new WPEC_Compare_GridView_Style_Tab();

/** 
 * wpec_compare_gridview_style_tab_manager()
 * Define the callback function to show tab content
 */
function wpec_compare_gridview_style_tab_manager() {
	global $wpec_compare_gridview_style_tab;
	$wpec_compare_gridview_style_tab->tab_manager();
}
