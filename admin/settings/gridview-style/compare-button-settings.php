...
<?php
/*-----------------------------------------------------------------------------------
WPEC Grid View Compare Button Settings
...
class WPEC_Compare_GridView_Compare_Button_Settings extends WPEC_Compare_Admin_UI
{
	 ...
	 */
	public $option_name = 'wpec_compare_grid_view_button_style';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'wpec_compare_grid_view_button_style';
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Card Compare Button Settings successfully saved.', 'wpec_cp' ),
				'error_message'		=> __( 'Error: Product Card Compare Button Settings can not save.', 'wpec_cp' ),
				'reset_message'		=> __( 'Product Card Compare Button Settings successfully reseted.', 'wpec_cp' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'compare-button',
			'label'				=> __( 'Product Card Compare Button', 'wpec_cp' ),
			'callback_function'	=> 'wpec_compare_gridview_compare_button_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' => __( 'Product Card Compare Button / Hyperlink ', 'wpec_cp' ),
                'type' => 'heading',
           	),
			array(  
			...
			array(  
				'name' 		=> __( 'Compare Success Icon', 'wpec_cp' ),
				'desc_tip'	=> __( 'Upload a 16px x 16px image, support .jpg, .pgn, .jpeg, .gif formats.', 'wpec_cp' ),
				'id' 		=> 'wpec_compare_gridview_product_success_icon',
				'type' 		=> 'upload',
			...
			array(
            	'name' 		=> __( 'Product Card Compare Hyperlink Styling', 'wpec_cp' ),
                'type' 		=> 'heading',
			...
			array(  
				...
				'id' 		=> 'link_text',
				'type' 		=> 'text',
				'default'	=> __('Compare This', 'wpec_cp')
			),
			array(  
			...
			array(
            	'name' 		=> __( 'Product Card Compare Button Styling', 'wpec_cp' ),
                'type' 		=> 'heading',
...
global $wpec_compare_gridview_compare_button_settings;
$wpec_compare_gridview_compare_button_settings = new WPEC_Compare_GridView_Compare_Button_Settings();

/** 
 * wpec_compare_gridview_compare_button_settings_form()
 * Define the callback function to show subtab content
 */
function wpec_compare_gridview_compare_button_settings_form() {
	global $wpec_compare_gridview_compare_button_settings;
	$wpec_compare_gridview_compare_button_settings->settings_form();
}
