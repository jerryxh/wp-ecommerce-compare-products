...
class WPEC_Compare_Comparison_Page_Style_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Comparison Page Style successfully saved.', 'wpec_cp' ),
				'error_message'		=> __( 'Error: Comparison Page Styles can not save.', 'wpec_cp' ),
				'reset_message'		=> __( 'Comparison Page Style successfully reseted.', 'wpec_cp' ),
			);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Comparison Page Header', 'wpec_cp' ),
                'type' 		=> 'heading',
           	),
			array(  
			...
			array(
            	'name' 		=> __( 'Comparison Page Body', 'wpec_cp' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Background Colour', 'wpec_cp' ),
			...
			array(
            	'name' 		=> __( 'Comparison Empty Window Message', 'wpec_cp' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Comparison Empty Window Message Text', 'wpec_cp' ),
				'desc' 		=> __( "Default <code>'[default_value]'</code>", 'wpec_cp' ),
				'id' 		=> 'no_product_message_text',
				'type' 		=> 'text',
				'default'	=> __('You do not have any product to compare.', 'wpec_cp')
			),
			array(  
				'name' 		=> __( "Text Alignment", 'wpec_cp' ),
				'desc' 		=> __( "Default <code>Center</code>.", 'wpec_cp' ),
