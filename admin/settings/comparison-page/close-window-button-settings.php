...
class WPEC_Compare_Close_Window_Button_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Close Window Button Settings successfully saved.', 'wpec_cp' ),
				'error_message'		=> __( 'Error: Close Window Button Settings can not save.', 'wpec_cp' ),
				'reset_message'		=> __( 'Close Window Button Settings successfully reseted.', 'wpec_cp' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Close Window Button', 'wpec_cp' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Close Window Button / Hyperlink', 'wpec_cp' ),
                'type' 		=> 'heading',
           	),
			array(  
			...
			array(
            	'name' 		=> __( 'Compare Table Close Window Hyperlink Styling', 'wpec_cp' ),
                'type' 		=> 'heading',
			...
			array(  
				...
				'id' 		=> 'close_link_text',
				'type' 		=> 'text',
				'default'	=> __('Close window', 'wpec_cp')
			),
			array(  
			...
			array(
            	'name' 		=> __( 'Compare Table Close Window Button Styling', 'wpec_cp' ),
                'type' 		=> 'heading',
