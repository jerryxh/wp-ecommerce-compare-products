...
class WPEC_Compare_Comparison_Page_Product_Prices_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Prices Settings successfully saved.', 'wpec_cp' ),
				'error_message'		=> __( 'Error: Product Prices Settings can not save.', 'wpec_cp' ),
				'reset_message'		=> __( 'Product Prices Settings successfully reseted.', 'wpec_cp' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'product-prices',
			'label'				=> __( 'Product Prices', 'wpec_cp' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( "Product Prices On Compare Table", 'wpec_cp' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( "Product Price", 'wpec_cp' ),
			...
			array(
				'name' 		=> __( 'Product Price Settings', 'wpec_cp' ),
                'type' 		=> 'heading',
				'class'		=> 'product_price_activated_container',
           	),
			array(  
				'name' 		=> __( "Product Price Position", 'wpec_cp' ),
				'desc' 		=> __( "Default <code>Top and Bottom</code>.", 'wpec_cp' ),
				'id' 		=> 'product_price_position',
				'css' 		=> 'width:160px;',
				'type' 		=> 'select',
				'default'	=> 'both',
				'options'	=> array(
						'both'			=> __( 'Top and Bottom', 'wpec_cp' ) ,	
						'top'			=> __( 'Top Only', 'wpec_cp' ) ,	
						'bottom'		=> __( 'Bottom Only', 'wpec_cp' ) ,
					),
			),
			array(  
				'name' 		=> __( 'Price Font', 'wpec_cp' ),
				'id' 		=> 'price_font',
				'type' 		=> 'typography',
