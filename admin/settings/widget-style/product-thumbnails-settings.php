...
class WPEC_Compare_Widget_Product_Thumbnails_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Widget Product Thumbnails Settings successfully saved.', 'wpec_cp' ),
				'error_message'		=> __( 'Error: Widget Product Thumbnails Settings can not save.', 'wpec_cp' ),
				'reset_message'		=> __( 'Widget Product Thumbnails Settings successfully reseted.', 'wpec_cp' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Product Thumbnails', 'wpec_cp' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' => __( "Product Thumbnails in Widget", 'wpec_cp' ),
                'type' => 'heading',
           	),
			array(  
				'name' 		=> __( 'Product Thumbnails', 'wpec_cp' ),
				'desc'		=> __('ON to show Product Thumbnails when items added to the Compare Widget.', 'wpec_cp'),
			...
			array(  
				'name' 		=> __( 'Thumbnail Wide', 'wpec_cp' ),
				'desc' 		=> 'px ' .__( "Default <code>'[default_value]'</code>px", 'wpec_cp' ),
				'id' 		=> 'thumb_wide',
				'css' 		=> 'width:40px;',
				'type' 		=> 'text',
				'default'	=> 32,
			...
			array(  
				'name' 		=> __( 'Thumbnail Padding', 'wpec_cp' ),
				'desc' 		=> 'px ' .__( "Default <code>'[default_value]'</code>px", 'wpec_cp' ),
				'id' 		=> 'thumb_padding',
				'css' 		=> 'width:40px;',
				'type' 		=> 'text',
			...
			array(  
				'name' 		=> __( "Thumbnail Alignment", 'wpec_cp' ),
				'id' 		=> 'thumb_align',
				'css' 		=> 'width:80px;',
				'type' 		=> 'select',
				'default'	=> 'left',
			...
			array(  
				'name' 		=> __( 'Thumbnail Background Colour', 'wpec_cp' ),
			...
			array(  
				'name' 		=> __( 'Thumbnail Border', 'wpec_cp' ),
				'id' 		=> 'thumb_border',
				'type' 		=> 'border',
			...
			array(  
				'name' 		=> __( 'Thumbnail Shadow', 'wpec_cp' ),
				'id' 		=> 'thumb_shadow',
				'type' 		=> 'box_shadow',
