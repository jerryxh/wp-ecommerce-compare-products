...
class WPEC_Compare_Widget_Clear_All_Items_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Widget Clear All Items Settings successfully saved.', 'wpec_cp' ),
				'error_message'		=> __( 'Error: Widget Clear All Items Settings can not save.', 'wpec_cp' ),
				'reset_message'		=> __( 'Widget Clear All Items Settings successfully reseted.', 'wpec_cp' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Clear All Items', 'wpec_cp' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' => __( "'Clear All' Items Button / Hyperlink", 'wpec_cp' ),
                'type' => 'heading',
           	),
			array(  
			...
			array(  
				'name' 		=> __( "'Clear All' Items Vertical Align", 'wpec_cp' ),
				'desc' 		=> __('Relative to Compare Widget Button.', 'wpec_cp') . ' ' .__( "Default <code>Below</code>.", 'wpec_cp' ),
				'id' 		=> 'clear_all_item_vertical',
				'css' 		=> 'width:80px;',
				'type' 		=> 'select',
				'default'	=> 'below',
				'options'	=> array(
						'above'			=> __( 'Above', 'wpec_cp' ) ,	
						'below'			=> __( 'Below', 'wpec_cp' ) ,
					),
			),
			array(  
				'name' 		=> __( "'Clear All' Items Horizontal Align", 'wpec_cp' ),
			...
			array(
            	'name' 		=> __( "'Clear All' Items Linked Text Styling", 'wpec_cp' ),
                'type' 		=> 'heading',
			...
			array(
            	'name' 		=> __( "'Clear All' Items Button Styling", 'wpec_cp' ),
                'type' 		=> 'heading',
