...
class WPEC_Compare_Product_Page_Compare_Button_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Page Compare Button Settings successfully saved.', 'wpec_cp' ),
				'error_message'		=> __( 'Error: Product Page Compare Button Settings can not save.', 'wpec_cp' ),
				'reset_message'		=> __( 'Product Page Compare Button Settings successfully reseted.', 'wpec_cp' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'compare-button',
			'label'				=> __( 'Product Page Compare Button', 'wpec_cp' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' => __( 'Product Page Compare Button / Hyperlink ', 'wpec_cp' ),
                'type' => 'heading',
           	),
			array(  
			...
			array(
            	'name' 		=> __( 'Product Page Compare Hyperlink Styling', 'wpec_cp' ),
                'type' 		=> 'heading',
			...
			array(
            	'name' 		=> __( 'Product Page Compare Button Styling', 'wpec_cp' ),
                'type' 		=> 'heading',
