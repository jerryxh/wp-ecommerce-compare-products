...
-----------------------------------------------------------------------------------*/
class WPEC_Compare_Uploader extends WPEC_Compare_Admin_UI
{
	 ...
	 * @var string
	 */
	private $custom_post_type_image = 'wpec_compare_images';
	
	/**
	 * @var string
	 */
	private $custom_post_type_name = 'WPEC Compare Internal Container';
	...
	public function upload_input ( $name_attribute, $id_attribute = '', $value = '', $default_value = '', $field_name = '', $class = '', $css = '', $description = '', $post_id = 0 ) {
		...
		$output .= '<input id="upload_'.$id_attribute.'" class="a3rev-ui-upload-button a3_upload_button button" type="button" value="'.__( 'Upload', 'wpec_cp' ).'" rel="'.$post_id.'" /> '.$description;
...
global $wpec_compare_uploader;
$wpec_compare_uploader = new WPEC_Compare_Uploader();
